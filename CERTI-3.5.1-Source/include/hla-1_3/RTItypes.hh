...
#define RTI_VERSION "CERTI_3.5.1git"
#define RTI_INTERNAL_VERSION "CERTI_3.5.1git"

#define RTI_MAJOR_VERSION 3
#define RTI_MINOR_VERSION 5
#define RTI_RELEASE 1git

#define RTI_INTERNAL_MAJOR_VERSION 3
#define RTI_INTERNAL_MINOR_VERSION 5
#define RTI_INTERNAL_RELEASE 1git
