...
public:
    ...
    //friend RTI_STD::ostream FEDTIME_EXPORT &operator<<(RTI_STD::ostream&, const RTI::FedTime &);edit by jihang
	friend std::ostream FEDTIME_EXPORT &operator<<(std::ostream&, const RTI::FedTime &);
