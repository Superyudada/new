...
#define RTI_STD std
#else
//#include <fstream.h>,edit by jihang
#include <fstream>
#define RTI_STD
#endif
...
//RTI_STD::ostream RTI_EXPORT &edit by jihang
std::ostream RTI_EXPORT &
//operator<<(RTI_STD::ostream &os, RTI::Exception *ex);edit by jihang
operator<<(std::ostream &os, RTI::Exception *ex);

//RTI_STD::ostream RTI_EXPORT &edit by jihang
std::ostream RTI_EXPORT &
//operator<<(RTI_STD::ostream &os, RTI::Exception const &ex);edit by jihang
operator<<(std::ostream &os, RTI::Exception const &ex);
